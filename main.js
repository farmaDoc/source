  ...
  function detectIntent(input, intents) {
    return new Promise((resolve, reject) => {
      ...
      createCorpus(intents).then((corpus) => {
        ...
        console.log(objres)
        let undersiredlemmas = ["alquanto", "altrettanto", "altro", "altrui", "ambedue", "ambedui", "ambidue", "ambidui", "ambo", "ambodue", "amendua", "amendue", "ben altro", "cadauno", "certuno", "che", "ciascheduno", "ciascuno", "codesto", "cotale", "cotanto", "cotesto", "cotevesto", "cui", "entrambi", "esto", "istesso", "lor", "loro", "Loro", "medesimo", "meno", "mio", "molto", "nessuno", "neuno", "niente", "niuno", "no", "nostro", "nullo", "ogne", "ogni", "parecchio", "poco", "qualche", "quale", "quanto", "quantunque", "quello", "questo", "stesso", "suo", "tale", "taluno", "tantino", "tanto", "tramendue", "tramendui", "troppo", "tuo", "tutt'e", "tutti e", "tutto", "veruno", "vostro", "a meno che", "a seconda che", "abbenché", "acché", "acciò", "acciocché", "adunche", "adunque", "affinché", "al fine di", "allora", "allorché", "allorquando", "almeno", "ammesso che", "ancoraché", "ancorché", "ancorquando", "anzi", "anziche", "anziché", "avvegnaché", "avvengaché", "basta che", "benche", "benché", "beninteso che", "bensì", "ca", "caso mai", "casomai", "che", "chè", "ché", "come", "come se", "comunque", "conciossiaché", "conciossiacosaché", "così che", "cosicché", "dacché", "dal momento che", "dappoi", "dappoiché", "di modo che", "difatti", "dopo", "dopo che", "dopoché", "doppo", "dov'è", "dove", "a", "a causa di", "a danno di", "a decorrere da", "a detta di", "a differenza di", "a dispetto di", "a eccezione di", "a mezzo", "a nome di", "a partire da", "a prescindere da", "a proposito di", "a scapito di", "a seconda di", "a seguito di", "accanto", "ad", "ad eccezione di", "ad opera di", "addosso", "al", "al di là di", "al di qua di", "al di sopra", "al di sotto di", "al posto di", "all'infuori", "all'insaputa di", "all'interno di", "alla", "alla faccia di", "alla volta di", "altro che", "apo", "appo", "appresso", "assieme a", "attorno a", "attraverso", "avanti", "avanti Cristo", "ca", "ched", "circa", "col rispitto col", "con", "contra", "contro", "da", "da parte di", "dalli", "dappoi", "alcunché", "alquanto", "altrettanto", "altro", "altrui", "ambedue", "ambedui", "ambidue", "ambidui", "ambodue", "amendua", "amendue", "ben altro", "cadauno", "ce", "certuni", "certuno", "che", "che cosa", "checché", "checchessia", "chi", "chicchessia", "chiunque", "ci", "ciascheduno", "ciascuno", "ciò", "codestei", "codesto", "codestoro", "codestui", "colei", "coloro", "colui", "cosa", "costei", "costoro", "costui", "cotanto", "cotestei", "cotesto", "cotestoro", "cotestui", "cotevesto", "cui", "desso", "diversi", "egli", "eglino", "ei", "el", "ella", "Ella"].map(e=>e.toLocaleLowerCase())
        let inputphr = input.toLowerCase().split(/\W+/).filter(word => word !== '' && !undersiredlemmas.includes(word))
