async function farmadocInit(el) {
  ...
  let result = await fetch(
    "http://localhost:8888/.netlify/functions/checkIn?key=" + el,
    {
      method: "GET",
      mode: "cors",
      headers: {
  ...
  let usrIntents = await fetch(
    "http://localhost:8888/.netlify/functions/getIntents?createdBy=" +
    result?.res?.id,
    {
      method: "GET",
      mode: "cors",
  ...
  let sysIntents = await fetch(
    "http://localhost:8888/.netlify/functions/getIntents?createdBy=system",
    {
      method: "GET",
      mode: "cors",
      headers: {
  ...
  async function getDrugsInfo(id) {
    const respo = await fetch(
      "http://localhost:8888/.netlify/functions/getDrugs?id=" + id,
      {
        method: "GET",
        mode: "cors",
        headers: {
